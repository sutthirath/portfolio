    ...
    <Layout>
      ...
      <section className="project-section section-info1">
        ...
        <div className="details">
          ...
          <p>
            Explore the unknown or get help from locals. Yocal is mobile app
            using the Foursquare API to search hundreds of local businesses.
            Users can signup to become a yocal in their area to guide
            travellers. Real-time chat is intergrated to connect users with
            yocals to get advise when they're out adventuring.
          </p>
          <a
      ...
      <section className="project-section section-hero2">
        <img
      ...
      <section className="project-section section-info2">
        <div className="details">
          ...
          <p>
            ...
            Vilaysane, Henry Hong, and Chris Tack. Easy to navigate interface
            with a beautiful visualization of local transit data.
          </p>
          <a
      ...
      <section className="project-section section-info3">
        ...
        <div className="details">
          ...
          <p>
            Lightweight web browser game that is built with intuiutive
            javascript. No extra libraries or frameworks invovled. Delivering a
